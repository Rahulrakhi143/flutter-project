...
class Mystreambuilder {
 ...
 var Value = "";
  ...
  Widget Mystream(StateSetter setState,DatabaseShow) {
              ...
              if(Value.isEmpty) {
                ...
                return ListView.builder(
                        ...
                        child: ListTile(
                          onTap: B==false ? (){
                            ...
                            setState((){
                              ...
                              _Phone = int.parse(list[index]["id"]);
                              B=true;
                            });
                          } : (){
                            ...
                            setState(() {
                             ...
                             CPhone.text =  list[index]["Phone"].toString();
                              TextEditingController CName = TextEditingController();
                               CName.text = list[index]["Name"];
                              TextEditingController Jama = TextEditingController();
                              Jama.text = list[index]["Jama"].toString();
                              print(list[index].length);
                              for(int i=0;i<(list[index].length-8)/3;i++)
                                {
                                  TextEditingController C1 = TextEditingController();
                                  C1.text = list[index]["Item ${i}"];
                                  l1.add(C1);
                                  TextEditingController C2 = TextEditingController();
                                  C2.text = list[index]["kg ${i}"];
                                  l2.add(C2);
                                  TextEditingController C3 = TextEditingController();
                                  C3.text = list[index]["Amount ${i}"];
                                  l3.add(C3);
                                  TextEditingController C4 = TextEditingController();
                                  C4.text = (double.parse(C2.text) * double.parse(C3.text)).toString();
                                  l4.add(C4);
                                }
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context) {
                                    return MyHScreen().NewScreen(
                                        context,
                                        l1,
                                        l2,
                                        l3,
                                        ...
                                        0.0,
                                         Jama,
                                        list[index]["Purana Baki"].toString(),
                                        CName,
                                        CPhone,
                                        list[index]["id"],
                                        list[index]["Day"],
                          ...
                          tileColor: Color.fromARGB(150, 227, 100, 78),
                          title: MyAppTextStyle().MyTextB(context, "${B==false ? list[index]["id"] : list[index]["Day"]}"),
                          subtitle:B== false ? MyAppTextStyle().MyText(context, "${ list[index]["Name"]}") : null,
                          trailing: B== false ? MyAppTextStyle().MyText(context,list[index]["Purana Baki"]) : MyAppTextStyle().MyTextB(context,"total Amount"),
                        ),
                      );
                    }) ;
              }
                  ...
                  // print(Value.runtimeType);
                    list = map.values.where((id) =>
                        id.toString().toLowerCase().contains(
                          ...
                          return Card(
                            child: ListTile(
                              onTap: B==false ? (){
                                ...
                                //   return MyHScreen().NewScreen(context, TextController, QuentityController, AmountController, TotalController, sum, JamaController, PuranaBaki,, CostumerPhone, Cuser)
                                // }));
                              },
                              tileColor: Color.fromARGB(150, 227, 100, 78),
                              title: MyAppTextStyle().MyTextB(context, "${B==false ? list[index]["id"] : list[index]["Time"]}"),
                              subtitle:B== false ? MyAppTextStyle().MyText(context, "${ list[index]["Name"]}") : null,
                              trailing: B== false ? null : MyAppTextStyle().MyTextB(context,"total Amount"),
                            ),
                          );
                        }) ;
              }
